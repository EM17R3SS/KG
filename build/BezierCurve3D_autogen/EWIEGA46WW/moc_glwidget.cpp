...
template <> constexpr inline auto GLWidget::qt_create_metaobjectdata<qt_meta_tag_ZN8GLWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'generateBSplineSurface'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'performClipping'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'generateLines'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'generateZBufferScene'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'renderRayTracing'
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->generateBSplineSurface(); break;
        case 1: _t->performClipping(); break;
        case 2: _t->generateLines(); break;
        case 3: _t->generateZBufferScene(); break;
        case 4: _t->renderRayTracing(); break;
        default: ;
        }
    }
    (void)_a;
